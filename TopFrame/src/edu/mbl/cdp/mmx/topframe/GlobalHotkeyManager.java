...
// From: http://www.javaspecialists.eu/archive/Issue007.html
...
public class GlobalHotkeyManager extends EventQueue {
    ...
    /*
    // GlobalHotkeyManager Usage Example
		* 
		// Define the hot key...
    
    private final static String QQQ_KEY = "UIRobot";
		
    private final KeyStroke qqqHotkey = 
		  KeyStroke.getKeyStroke(KeyEvent.VK_R, KeyEvent.CTRL_MASK + KeyEvent.ALT_MASK, false);
